...
class BilanComptes(object):
    ...
    @staticmethod
    def bilan(dossier_destination, edition, sommes, clients, generaux, comptes):
        """
        création du bilan
                ...
                if code_client in sommes.sommes_comptes:
                    ...
                    for num_compte, id_compte in sorted(comptes_utilises.items()):
                        ...
                        ligne = [edition.annee, edition.mois, reference, code_client, client['code_sap'],
                                 client['abrev_labo'], client['nom_labo'], 'U', client['type_labo'], id_compte, num_compte,
                                 compte['intitule'], "", Outils.format_2_dec(sco['somme_j_mai']),
